      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-gray-600 text-sm mt-1">
            ماتریس مسئولیت‌ها بر اساس ۳ نقش اصلی
          </p>
        </div>
        {canManage && (
          <button
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <select
                  name="super_admin_responsibility"
                  value={formData.super_admin_responsibility}
                  onChange={handleChange}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none transition"
                >
              ...
              <div>
                ...
                <select
                  name="org_admin_responsibility"
                  value={formData.org_admin_responsibility}
                  onChange={handleChange}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none transition"
                >
                  {Object.entries(respLabels).map(([key, label]) => (
              ...
              <div>
                ...
                <select
                  name="org_user_responsibility"
                  value={formData.org_user_responsibility}
                  onChange={handleChange}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none transition"
                >
                  {Object.entries(respLabels).map(([key, label]) => (
            ...
            <button
              type="submit"
              disabled={loading}
              className="mt-4 bg-blue-600 hover:bg-blue-700 text-white font-medium py-2.5 px-6 rounded-lg transition disabled:opacity-50"
            >
