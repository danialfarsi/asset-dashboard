      ...
      <form onSubmit={onSubmit} className="space-y-6" noValidate>
        ...
        <Card>
          ...
          <CardContent className="grid grid-cols-2 gap-4">
            ...
            <div><Label>تاریخ</Label><JalaliDatePicker
              value={formData.date}
        ...
        <Card>
          ...
          <CardContent className="grid grid-cols-3 gap-4">
            ...
            <div><Label>تاریخ</Label><JalaliDatePicker
              ...
              onChange={(date) => setFormData({ ...formData, prepared_date: date })}
            /></div>
            ...
            <div><Label>تاریخ</Label><JalaliDatePicker
              ...
              onChange={(date) => setFormData({ ...formData, reviewed_date: date })}
            /></div>
            ...
            <div><Label>تاریخ</Label><JalaliDatePicker
              ...
              onChange={(date) => setFormData({ ...formData, approved_date: date })}
            /></div>
          </CardContent>
        </Card>
