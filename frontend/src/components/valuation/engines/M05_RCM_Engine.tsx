  ...
  return (
    <div className="space-y-6" dir="rtl">
      ...
      <div className="bg-emerald-50 p-4 rounded-lg border border-emerald-200">
        <p className="text-sm text-emerald-700 font-[family-name:var(--font-vazir)]">
                      ...
                      {laborDetails.map((item: any, index: number) => (
                        <tr key={index} className="hover:bg-gray-50">
                          ...
                          <td className="border p-2 text-center font-[family-name:var(--font-vazir)]">
                            {toPersianNumber(item.person_months)}
                          </td>
                          <td className="border p-2 font-[family-name:var(--font-vazir)]">{formatNumber(item.monthly_rate)}</td>
                          <td className="border p-2 font-[family-name:var(--font-vazir)]">{formatNumber(item.person_months * item.monthly_rate)}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
