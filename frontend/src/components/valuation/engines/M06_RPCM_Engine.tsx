                  ...
                  <tbody>
                    {laborDetails.map((item: any, index: number) => (
                      <tr key={index} className="hover:bg-gray-50">
                        ...
                        <td className="border p-2 font-mono">{formatNumber(item.daily_rate)}</td>
                        <td className="border p-2 font-mono">{formatNumber(item.person_days * item.daily_rate)}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
